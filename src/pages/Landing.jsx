...
// import { Zap, Shield, Cpu, CreditCard, ArrowRight, Server, Globe, Lock, Cloud, ChevronRight, LogIn, AlertCircle, CheckCircle } from "lucide-react";
...
//               <Link to="/login">
//                 <button className="px-4 py-2 text-sm text-primary/80 hover:text-primary hover:bg-primary/5 rounded-lg border border-primary/20 transition-colors duration-200">
//                   Log In
//                 </button>
//               </Link>
//               <Link to="/register">
//                 <button className="px-4 py-2 text-sm bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 rounded-lg transition-all duration-200">
//                   Get Started
//                 </button>
//               </Link>
//             </div>
...
//                 {/* <div className="flex items-center gap-2 px-4 py-2 bg-background/90 backdrop-blur-sm border border-border rounded-full">
...
//             <p className="text-muted-foreground font-mono text-sm">
//               © {new Date().getFullYear()} WolfHost Infrastructure. All systems operational.
//             </p>
//           </div>
//         </div>
//       </footer>
...
// A NeonBackground component being used with intensity={0.6}

// Various glassmorphism effects