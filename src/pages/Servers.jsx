...
//         <div>
//           <h1 className="text-2xl sm:text-3xl font-display font-bold text-primary/90">
//             My Servers
//           </h1>
...
//         </div>
//         <motion.button
//           className="px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 rounded-lg flex items-center gap-2 transition-all duration-200"
...
//           <motion.div
//             className={`
//               fixed top-20 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg
...
//               className="neon-input opacity-90 pl-10"
//             />
//           </div>

//           {/* View Toggle */}
//           <div className="flex items-center gap-2 border border-border/30 rounded-lg p-1">
//             <button
//               className={`p-2 rounded ${viewMode === 'grid' ? 'bg-primary/5 text-primary/90' : 'text-muted-foreground'}`}
//               onClick={() => setViewMode('grid')}
//             >
//               <Grid size={18} />
//             </button>
//             <button
//               className={`p-2 rounded ${viewMode === 'list' ? 'bg-primary/5 text-primary/90' : 'text-muted-foreground'}`}
...
//           <h3 className="text-lg font-display mb-2">No servers found</h3>
//           <p className="text-muted-foreground mb-4">
//             {searchQuery ? 'Try a different search term' : 'Create your first server to get started'}
//           </p>
//           {!searchQuery && (
//             <button
//               className="px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 rounded-lg inline-flex items-center gap-2 transition-all duration-200"
//               onClick={() => setShowCreateModal(true)}
//             >
//               <Plus size={16} />
//               Create Server
...
//           >
//             <motion.div
//               className="w-full max-w-md bg-background/95 backdrop-blur-sm border border-border/30 rounded-xl shadow-lg"
...
//                   <h2 className="text-xl font-display font-bold text-primary/90">Create New Server</h2>
//                   <button
//                     onClick={() => setShowCreateModal(false)}
//                     className="p-2 hover:bg-primary/5 rounded-lg transition-colors text-muted-foreground hover:text-foreground"
//                   >
//                     <X size={20} />
//                   </button>
//                 </div>
...
//                       type="button"
//                       onClick={() => setShowCreateModal(false)}
//                       className="px-4 py-2 text-foreground/80 hover:text-foreground hover:bg-foreground/5 border border-border rounded-lg flex-1 transition-all duration-200"
//                     >
//                       Cancel
//                     </button>
//                     <button
//                       type="submit"
//                       className="px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 rounded-lg flex-1 flex items-center justify-center gap-2 transition-all duration-200"
//                       disabled={creating}
//                     >
...
//           >
//             <motion.div
//               className="w-full max-w-2xl bg-background/95 backdrop-blur-sm border border-border/30 rounded-xl shadow-lg"
//               initial={{ scale: 0.9, opacity: 0 }}
//               animate={{ scale: 1, opacity: 1 }}
//               exit={{ scale: 0.9, opacity: 0 }}
//               onClick={(e) => e.stopPropagation()}
...
//                   <h2 className="text-xl font-display font-bold text-primary/90">
...
//                 <div className="bg-background border border-border/30 rounded-lg p-4 h-64 overflow-y-auto font-mono text-sm">
//                   <div className="text-primary/90">$ server start</div>
//                   <div className="text-muted-foreground">[INFO] Starting server...</div>
//                   <div className="text-muted-foreground">[INFO] Loading configuration...</div>
//                   <div className="text-primary/90">[OK] Server started on {selectedServer.ip}:25565</div>
//                   <div className="text-muted-foreground">[INFO] Memory allocated: 2048MB</div>
//                   <div className="text-primary/90">[OK] Ready for connections!</div>
